...
public slots:
    ...
    /**
     * @brief Отправка данных для выполнения задачи 3.
     * 
     * Метод для отправки данных задачи 3 на сервер, включая функцию, начальные значения, 
     * допуск и максимальное количество итераций.
     * @param func Функция задачи.
     * @param x0 Начальное значение x0.
     * @param x1 Начальное значение x1.
     * @param epsilon Допуск для решения.
